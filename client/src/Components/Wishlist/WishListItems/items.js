  ...
  return (
    <div className="flashsale">
      <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: '10px' }}>
        <span className="font-semibold text-black text-md md:text-md lg:text-2xl xl:text-2xl pl-20 ml-20" style={{ marginBottom: '-5px', marginTop: '20px' }}>You have {itemsCount} items in your Wishlist</span>
      </div>
