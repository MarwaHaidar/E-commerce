...
import { validateToken,validateRefreshToken,validateTokenForAdmin } from '../Middleware/validateTokenHandler.js';
...
router.get('/categories',validateToken,validateRefreshToken, getcategories)
